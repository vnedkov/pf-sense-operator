...
// DNSResolverHostOverrideReconciler reconciles a DNSResolverHostOverride object
type DNSResolverHostOverrideReconciler struct {
	client.Client
...
// the DNSResolverHostOverride object against the actual cluster state, and then
...
func (r *DNSResolverHostOverrideReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&pfsensev1beta1.DNSResolverHostOverride{}).
		Named("dnsresolverhostoverride").
		Complete(r)
}
